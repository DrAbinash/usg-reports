...
export async function GET(_req: Request, ctx: Ctx) {
  ...
  // FINALIZED reports return the frozen reportHtml snapshot as-is.
  // Never rebuild from stateJson on open — that would rewrite the printed
  // record when organ schemas evolve (grid migration, wording tweaks).
