...
export const USG_PATHOLOGIES: UsgPathologyDef[] = [
  ...
  P({
    ...
    text: "Uterus is bulky in size and shape & measures {u1} x {u2} x {u3} cm. There is evidence of an ill defined hyperechoic subserosal lesion (measuring {d1} x {d2} cm) arising from {wall_loc} uterine wall suggestive of Fibroid. The cervical echo is normal.",
    impression: ["Bulky uterus with {wall_loc} subserosal fibroid."],
    titleFragment: "{wall_loc} subserosal fibroid",
    vars: [V("u1", "L", "cm"), V("u2", "W", "cm"), V("u3", "H", "cm"), V("d1", "Fibroid L"), V("d2", "Fibroid W"), { key: "wall_loc", label: "Wall location", unit: "" }],
  }),
  P({
    key: "uterus-fibroid-intramural", organ: "uterus", label: "Fibroid — Intramural", category: "Uterus",
    text: "Uterus is bulky in size and shape & measures {u1} x {u2} x {u3} cm. There is evidence of an ill defined hyperechoic intramural lesion (measuring {d1} x {d2} cm) in {wall_loc} region, suggestive of Fibroid. The cervical echo is normal.",
    impression: ["Bulky uterus with {wall_loc} intramural fibroid."],
    titleFragment: "{wall_loc} intramural fibroid",
    vars: [V("u1", "L", "cm"), V("u2", "W", "cm"), V("u3", "H", "cm"), V("d1", "Fibroid L"), V("d2", "Fibroid W"), { key: "wall_loc", label: "Wall location", unit: "" }],
  }),
  P({
